...
In many ways, the Onyxia project aims at building commons in the realms of official statistics. First of all, by being a fully open-source initiative \cite{}. 



- Utilisation de communs : briques open-source
- Projet open-source -> permettre des réinstanciations dans d'autres orgas
